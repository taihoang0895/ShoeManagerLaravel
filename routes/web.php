...
Route::get("marketing/detail-marketing-product/", "MarketingController@detailMarketingProductCode")->middleware("auth",'permission')->name("marketing-detail-marketing-product");
...
Route::get("product/price/", "SaleController@queryMarketingProductPrice")->middleware("auth",'permission')->name("sale-product-price");
