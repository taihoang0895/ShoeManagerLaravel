...
function addNewDetailOrder(){
       ...
       $.get('/marketing-product/price', param, function(response) {
              if(response['status'] == 200){

                   var price = response['content']['price'];
                   var row_index = $('.tbl_detail_order_item').length;
                   $('#row_additional_detail_order').after(genRow(productCode,productSize, productColor, quantity, productDiscount, price, price,0, row_index));
