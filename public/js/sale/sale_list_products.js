...
$(document).ready(function () {
     $('#list_product_size a').click(function(){
            $('#dropdown_product_size_text').text($(this).text());
    });

    $('#list_product_color a').click(function(){
            $('#dropdown_product_color_text').text($(this).text());
    });
