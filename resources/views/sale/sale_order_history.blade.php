@extends ('base_layout')
@section('extra_head')
    <link rel="stylesheet" href={{ asset('css/sale/sale_product_history.css' ) }}>
...
@section('content')
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item">
            <a class="nav-link" href="/sale/exporting-product-history/">Xuất Hàng</a>
        </li>

        <li class="nav-item">
            <a class="nav-link active" href="/sale/importing-product-history/">Đặt Hàng</a>
        </li>
    ...
    <table class="tbl_histories">
        <tr class="tbl_header_item">
            ...
            <td class="code">MHD</td>
            <td class="sale_name">Người Lập</td>
        ...
        @foreach ($list_histories as $history)
            ...
            <tr class="tbl_item returning_product_row">
                <td class="date">{{$history->created_str}}</td>
                <td class="username">{{$history->username}}</td>
                <td class="action">{{$history->action}}</td>
                <td class="code">{{$history->code}}</td>
                <td class="sale_name">{{$history->sale_name}}</td>
                <td class="order_state">{{$history->order_state_name}}</td>
