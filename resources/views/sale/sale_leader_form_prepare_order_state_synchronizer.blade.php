<link rel="stylesheet" href={{ asset('css/sale/sale_leader_form_prepare_order_state_synchronizer.css') }}>
<script src={{ asset('js/sale/sale_leader_form_prepare_order_state_synchronizer.js') }}></script>
<meta name="csrf-token" content="{{ Session::token() }}">
<form method="post">
    @csrf
    <div id="order_state_synchronizer_dialog">
        <div id="order_state_synchronizer_dialog_content">
            <div class="title">Danh Sách Đồng Bộ Hóa Đơn</div>
            <table class="tbl_order_state_synchronizer" id="tbl_order_state_synchronizer">
                ...
                @foreach ($list_orders as $order)
                    <tr class="tbl_item order_state_synchronizer_row" id="order_state_synchronizer_row_{{$order->id}}">
