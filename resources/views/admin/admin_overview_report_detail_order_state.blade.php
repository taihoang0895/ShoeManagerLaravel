...
<head>
    ...
    <link rel="stylesheet" href={{ asset('css/admin/admin_overview_report_detail_order_state.css' ) }}>
    <script src={{ asset('js/admin/admin_overview_report_detail_order_state.js' ) }}></script>
...
<div id="filter_panel">
    <form method="get" action="/admin/overview-report-detail_order_state/">
                ...
                <td width="50%">
                    <table width="100%" class="table table-bordered table-dark table-striped"
                        ...
                        <tr>
                            ...
                            <td>
                                <h4>{{$summary->total_pending_order}}</h4>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <h4>{{$summary->total_success_order}}</h4>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <h4>{{$summary->total_returning_order}}</h4>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <h4>{{$summary->total_delivering_order}}</h4>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <h4>{{$summary->total_cancel_order}}</h4>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                ...
                <td width="50%" valign="top">
                    <table width="100%" class="table table-bordered table-dark table-striped"
                        ...
                        <tr>
                            ...
                            <td>
                                <h4>{{$summary->success_order_percent}}&#37;</h4>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <h4>{{$summary->returning_order_percent}}&#37;</h4>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <h4>{{$summary->cancel_order_percent}}&#37;</h4>
                            </td>
                        </tr>
                        </tbody>
                    </table>
