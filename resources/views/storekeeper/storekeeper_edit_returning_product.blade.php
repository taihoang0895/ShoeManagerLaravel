<link rel="stylesheet" href={{ asset('css/storekeeper/storekeeper_edit_returning_products.css') }}>
<script src={{ asset('js/storekeeper/storekeeper_edit_returning_products.js') }}></script>
<meta name="csrf-token" content="{{ Session::token() }}">

<form method="post">
    @csrf
    <input type="hidden" id="edit_returning_product_id" value="{{$returning_product->id}}">
    <div id="edit_returning_product_dialog">
        <div id="edit_returning_product_dialog_content">
            <div class="title">Nhập Số Lượng Hàng Hoàn</div>
            <table width="90%">
                <tr class="returning_product_field_row">
                    <td class="lbl_name" style="padding-top:0px;">MSP</td>
                    <td class="value" style="padding-top:0px;">

                        @if($returning_product->id > 0)
                ...
                <tr class="returning_product_field_row">
                    ...
                    <td class="value">
                        <input type="number" class="form-control" min="1" value="{{$returning_product->quantity}}"
                               id="product_quantity">
                    </td>
                </tr>
                <tr class="returning_product_field_row">
                    ...
                    <td class="value">
                        <textarea class="form-control" rows="4" id="note">{{$returning_product->note}}</textarea>
                    </td>
                </tr>
            </table>
            ...
            <table width="50%" style="margin-left:auto;margin-right:auto;margin-top : 15px;margin-bottom:15px">
                <tr>
                    <td style="text-align:center;">
                        <button type="button" class="btn btn-secondary btn_ok" id="edit_returning_product_btn_ok">Lưu
                        </button>
                    </td>
                    <td style="text-align:center;">
                        <button type="button" class="btn btn-secondary btn_cancel"
                                id="edit_returning_product_btn_cancel">Hủy
                        </button>
                    </td>
                </tr>
            </table>
